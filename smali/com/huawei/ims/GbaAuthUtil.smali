...
.method public callBack(Lcom/huawei/ims/GbaAuth$AkaResult;Ljava/lang/Object;)V
    ...
    .prologue
    .line 26
    iget-object v3, p0, Lcom/huawei/ims/GbaAuthUtil;->mLock:Ljava/lang/Object;
    ...
    new-instance v0, Lcom/huawei/sci/SciSSConfAuth$AkaResult;

    invoke-direct {v0}, Lcom/huawei/sci/SciSSConfAuth$AkaResult;-><init>()V

    .line 30
    .local v0, "aka":Lcom/huawei/sci/SciSSConfAuth$AkaResult;
    iget-object v4, p0, Lcom/huawei/ims/GbaAuthUtil;->mGbaAuth:Lcom/huawei/ims/GbaAuth;
    ...
    .line 31
    :try_start_1
    iget-object v2, p1, Lcom/huawei/ims/GbaAuth$AkaResult;->mStatus:Lcom/huawei/ims/GbaAuth$AKA_ALGORITHM_STATUS;

    invoke-virtual {v2}, Lcom/huawei/ims/GbaAuth$AKA_ALGORITHM_STATUS;->getValue()I

    move-result v2

    invoke-virtual {v0, v2}, Lcom/huawei/sci/SciSSConfAuth$AkaResult;->setStatus(I)V

    .line 32
    iget-object v2, p1, Lcom/huawei/ims/GbaAuth$AkaResult;->mAkaData:Lcom/huawei/ims/GbaAuth$DataValue;
    ...
    iget-object v2, v2, Lcom/huawei/ims/GbaAuth$DataValue;->mValue:[B

    invoke-virtual {v0, v2}, Lcom/huawei/sci/SciSSConfAuth$AkaResult;->setAkaData([B)V
    ...
    .line 37
    invoke-virtual {v1, v0}, Lcom/huawei/sci/SciSSConfAuth$CallBackData;->setResultData(Ljava/lang/Object;)V
    ...
    .line 26
    .end local v0    # "aka":Lcom/huawei/sci/SciSSConfAuth$AkaResult;
...
.method public callBack(Lcom/huawei/ims/GbaAuth$BtidElem;Ljava/lang/Object;)V
    ...
    .prologue
    .line 46
    iget-object v2, p0, Lcom/huawei/ims/GbaAuthUtil;->mLock:Ljava/lang/Object;

    monitor-enter v2

    .line 47
    :try_start_0
    new-instance v0, Lcom/huawei/sci/SciSSConfAuth$CallBackData;

    invoke-direct {v0}, Lcom/huawei/sci/SciSSConfAuth$CallBackData;-><init>()V

    .line 49
    .local v0, "data":Lcom/huawei/sci/SciSSConfAuth$CallBackData;
    ...
    .line 50
    :try_start_1
    invoke-virtual {v0, p2}, Lcom/huawei/sci/SciSSConfAuth$CallBackData;->setAsyncSign(Ljava/lang/Object;)V

    .line 51
    invoke-virtual {p0, v0}, Lcom/huawei/ims/GbaAuthUtil;->callBack(Lcom/huawei/sci/SciSSConfAuth$CallBackData;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    .line 46
    .end local v0    # "data":Lcom/huawei/sci/SciSSConfAuth$CallBackData;
    :catchall_1
    move-exception v1
...
.method public getGBAKsnaf(I[B)Lcom/huawei/sci/SciSSConfAuth$GbaResult;
    ...
    invoke-virtual {v2, p1, p2}, Lcom/huawei/ims/GbaAuth;->getGBAKsnaf(I[B)Lcom/huawei/ims/GbaAuth$GbaResult;

    move-result-object v0

    .line 94
    .local v0, "authRet":Lcom/huawei/ims/GbaAuth$GbaResult;
    iget-object v2, v0, Lcom/huawei/ims/GbaAuth$GbaResult;->btid:Ljava/lang/String;

    invoke-virtual {v1, v2}, Lcom/huawei/sci/SciSSConfAuth$GbaResult;->setBtid(Ljava/lang/String;)V

    .line 95
    iget-object v2, v0, Lcom/huawei/ims/GbaAuth$GbaResult;->ksnaf:[B

    invoke-virtual {v1, v2}, Lcom/huawei/sci/SciSSConfAuth$GbaResult;->setKsnaf([B)V

    .line 96
    iget v2, v0, Lcom/huawei/ims/GbaAuth$GbaResult;->status:I

    invoke-virtual {v1, v2}, Lcom/huawei/sci/SciSSConfAuth$GbaResult;->setStatus(I)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    .line 91
    .end local v0    # "authRet":Lcom/huawei/ims/GbaAuth$GbaResult;
    :catchall_0
    move-exception v2
...
.method public triggerGBABootstrap(ILcom/huawei/sci/SciSSConfAuth$AkaAuthParams;Ljava/lang/Object;)I
    ...
    .prologue
    .line 69
    iget-object v1, p0, Lcom/huawei/ims/GbaAuthUtil;->mLock:Ljava/lang/Object;

    monitor-enter v1

    .line 70
    :try_start_0
    iget-object v0, p0, Lcom/huawei/ims/GbaAuthUtil;->mGbaAuth:Lcom/huawei/ims/GbaAuth;
    ...
    invoke-virtual {v0, p1, v2, v3, p3}, Lcom/huawei/ims/GbaAuth;->triggerGBABootstrap(I[B[BLjava/lang/Object;)I
    :try_end_0
...
.method public triggerGBABpUpdate(ILcom/huawei/sci/SciSSConfAuth$GbaBpParams;Ljava/lang/Object;)I
    ...
    .prologue
    .line 75
    iget-object v6, p0, Lcom/huawei/ims/GbaAuthUtil;->mLock:Ljava/lang/Object;
    ...
    invoke-virtual {v1, v3}, Lcom/huawei/ims/GbaAuth;->stringUtf8ToBytes(Ljava/lang/String;)[B
    ...
    .line 76
    invoke-virtual/range {v0 .. v5}, Lcom/huawei/ims/GbaAuth;->triggerGBABpUpdate(I[B[BLjava/lang/String;Ljava/lang/Object;)I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public triggerGBAKsNAF(I[BLjava/lang/String;Ljava/lang/Object;)I
    ...
    invoke-virtual {v0, p1, p2, v2, p4}, Lcom/huawei/ims/GbaAuth;->triggerGBAKsNAF(I[B[BLjava/lang/Object;)I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
