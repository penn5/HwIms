...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    .line 83
    .local v10, "_hidl_vec":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/hardware/radio/V1_0/CdmaCallWaiting;>;"
    ...
    .line 93
    new-instance v11, Landroid/hardware/radio/V1_0/CdmaCallWaiting;

    invoke-direct {v11}, Landroid/hardware/radio/V1_0/CdmaCallWaiting;-><init>()V

    .line 94
    .local v11, "_hidl_vec_element":Landroid/hardware/radio/V1_0/CdmaCallWaiting;
    mul-int/lit8 v1, v9, 0x38

    int-to-long v2, v1

    invoke-virtual {v11, p0, v13, v2, v3}, Landroid/hardware/radio/V1_0/CdmaCallWaiting;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    .line 99
    .end local v11    # "_hidl_vec_element":Landroid/hardware/radio/V1_0/CdmaCallWaiting;
    :cond_0
    return-object v10
.end method
...
.method public static final writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v4, v3, v6, v7}, Landroid/hardware/radio/V1_0/CdmaCallWaiting;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    const-class v2, Landroid/hardware/radio/V1_0/CdmaCallWaiting;
    ...
    .line 23
    check-cast v0, Landroid/hardware/radio/V1_0/CdmaCallWaiting;

    .line 24
    .local v0, "other":Landroid/hardware/radio/V1_0/CdmaCallWaiting;
    iget-object v1, p0, Landroid/hardware/radio/V1_0/CdmaCallWaiting;->number:Ljava/lang/String;

    iget-object v2, v0, Landroid/hardware/radio/V1_0/CdmaCallWaiting;->number:Ljava/lang/String;
    ...
    iget v2, v0, Landroid/hardware/radio/V1_0/CdmaCallWaiting;->numberPresentation:I
    ...
    iget-object v2, v0, Landroid/hardware/radio/V1_0/CdmaCallWaiting;->name:Ljava/lang/String;
    ...
    iget v2, v0, Landroid/hardware/radio/V1_0/CdmaCallWaiting;->numberType:I
    ...
    iget v2, v0, Landroid/hardware/radio/V1_0/CdmaCallWaiting;->numberPlan:I
...
.method public final readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    invoke-virtual {v0, p1, p2, v2, v3}, Landroid/hardware/radio/V1_0/CdmaSignalInfoRecord;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public final readFromParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, p1, v0, v2, v3}, Landroid/hardware/radio/V1_0/CdmaCallWaiting;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public final toString()Ljava/lang/String;
    ...
    .line 66
    const-string/jumbo v1, ", .signalInfoRecord = "
...
.method public final writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
    ...
    invoke-virtual {v0, p1, v2, v3}, Landroid/hardware/radio/V1_0/CdmaSignalInfoRecord;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final writeToParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, v0, v2, v3}, Landroid/hardware/radio/V1_0/CdmaCallWaiting;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
