...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    .line 69
    .local v10, "_hidl_vec":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/hardware/radio/V1_0/CdmaLineControlInfoRecord;>;"
    ...
    .line 79
    new-instance v11, Landroid/hardware/radio/V1_0/CdmaLineControlInfoRecord;

    invoke-direct {v11}, Landroid/hardware/radio/V1_0/CdmaLineControlInfoRecord;-><init>()V

    .line 80
    .local v11, "_hidl_vec_element":Landroid/hardware/radio/V1_0/CdmaLineControlInfoRecord;
    mul-int/lit8 v1, v9, 0x4

    int-to-long v2, v1

    invoke-virtual {v11, p0, v13, v2, v3}, Landroid/hardware/radio/V1_0/CdmaLineControlInfoRecord;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    .line 85
    .end local v11    # "_hidl_vec_element":Landroid/hardware/radio/V1_0/CdmaLineControlInfoRecord;
    :cond_0
    return-object v10
.end method
...
.method public static final writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v4, v3, v6, v7}, Landroid/hardware/radio/V1_0/CdmaLineControlInfoRecord;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    const-class v2, Landroid/hardware/radio/V1_0/CdmaLineControlInfoRecord;
    ...
    .line 21
    check-cast v0, Landroid/hardware/radio/V1_0/CdmaLineControlInfoRecord;

    .line 22
    .local v0, "other":Landroid/hardware/radio/V1_0/CdmaLineControlInfoRecord;
    iget-byte v1, p0, Landroid/hardware/radio/V1_0/CdmaLineControlInfoRecord;->lineCtrlPolarityIncluded:B

    iget-byte v2, v0, Landroid/hardware/radio/V1_0/CdmaLineControlInfoRecord;->lineCtrlPolarityIncluded:B
    ...
    iget-byte v2, v0, Landroid/hardware/radio/V1_0/CdmaLineControlInfoRecord;->lineCtrlToggle:B
    ...
    iget-byte v2, v0, Landroid/hardware/radio/V1_0/CdmaLineControlInfoRecord;->lineCtrlReverse:B
    ...
    iget-byte v2, v0, Landroid/hardware/radio/V1_0/CdmaLineControlInfoRecord;->lineCtrlPowerDenial:B
...
.method public final readFromParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, p1, v0, v2, v3}, Landroid/hardware/radio/V1_0/CdmaLineControlInfoRecord;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public final toString()Ljava/lang/String;
    ...
    .line 50
    const-string/jumbo v1, ".lineCtrlPolarityIncluded = "
...
.method public final writeToParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, v0, v2, v3}, Landroid/hardware/radio/V1_0/CdmaLineControlInfoRecord;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
