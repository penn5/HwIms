...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    .line 76
    .local v10, "_hidl_vec":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/hardware/radio/V1_0/HardwareConfig;>;"
    ...
    .line 86
    new-instance v11, Landroid/hardware/radio/V1_0/HardwareConfig;

    invoke-direct {v11}, Landroid/hardware/radio/V1_0/HardwareConfig;-><init>()V

    .line 87
    .local v11, "_hidl_vec_element":Landroid/hardware/radio/V1_0/HardwareConfig;
    mul-int/lit8 v1, v9, 0x40

    int-to-long v2, v1

    invoke-virtual {v11, p0, v13, v2, v3}, Landroid/hardware/radio/V1_0/HardwareConfig;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    .line 92
    .end local v11    # "_hidl_vec_element":Landroid/hardware/radio/V1_0/HardwareConfig;
    :cond_0
    return-object v10
.end method
...
.method public static final writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v4, v3, v6, v7}, Landroid/hardware/radio/V1_0/HardwareConfig;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    const-class v2, Landroid/hardware/radio/V1_0/HardwareConfig;
    ...
    .line 23
    .local v0, "other":Landroid/hardware/radio/V1_0/HardwareConfig;
    ...
    iget v2, v0, Landroid/hardware/radio/V1_0/HardwareConfig;->state:I
...
.method public final readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    iput v3, v0, Landroid/hardware/radio/V1_0/HardwareConfig;->type:I
    ...
    iput v3, v0, Landroid/hardware/radio/V1_0/HardwareConfig;->state:I
    ...
    iget-object v3, v0, Landroid/hardware/radio/V1_0/HardwareConfig;->modem:Ljava/util/ArrayList;
    ...
    invoke-virtual {v11, v0, v14, v4, v5}, Landroid/hardware/radio/V1_0/HardwareConfigModem;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    iget-object v3, v0, Landroid/hardware/radio/V1_0/HardwareConfig;->sim:Ljava/util/ArrayList;
    ...
    .line 127
    new-instance v12, Landroid/hardware/radio/V1_0/HardwareConfigSim;

    invoke-direct {v12}, Landroid/hardware/radio/V1_0/HardwareConfigSim;-><init>()V

    .line 128
    .local v12, "_hidl_vec_element":Landroid/hardware/radio/V1_0/HardwareConfigSim;
    ...
    invoke-virtual {v12, v0, v14, v4, v5}, Landroid/hardware/radio/V1_0/HardwareConfigSim;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    .line 132
    .end local v12    # "_hidl_vec_element":Landroid/hardware/radio/V1_0/HardwareConfigSim;
    :cond_1
    return-void
.end method
...
.method public final readFromParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, p1, v0, v2, v3}, Landroid/hardware/radio/V1_0/HardwareConfig;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public final writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
    ...
    invoke-virtual {v3, v2, v4, v5}, Landroid/hardware/radio/V1_0/HardwareConfigModem;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
    ...
    invoke-virtual {v3, v2, v4, v5}, Landroid/hardware/radio/V1_0/HardwareConfigSim;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final writeToParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, v0, v2, v3}, Landroid/hardware/radio/V1_0/HardwareConfig;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
