...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    .line 83
    .local v10, "_hidl_vec":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/hardware/radio/V1_0/LteSignalStrength;>;"
    ...
    .line 93
    new-instance v11, Landroid/hardware/radio/V1_0/LteSignalStrength;

    invoke-direct {v11}, Landroid/hardware/radio/V1_0/LteSignalStrength;-><init>()V

    .line 94
    .local v11, "_hidl_vec_element":Landroid/hardware/radio/V1_0/LteSignalStrength;
    mul-int/lit8 v1, v9, 0x18

    int-to-long v2, v1

    invoke-virtual {v11, p0, v13, v2, v3}, Landroid/hardware/radio/V1_0/LteSignalStrength;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    .line 99
    .end local v11    # "_hidl_vec_element":Landroid/hardware/radio/V1_0/LteSignalStrength;
    :cond_0
    return-object v10
.end method
...
.method public static final writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v4, v3, v6, v7}, Landroid/hardware/radio/V1_0/LteSignalStrength;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    const-class v2, Landroid/hardware/radio/V1_0/LteSignalStrength;
    ...
    .line 23
    check-cast v0, Landroid/hardware/radio/V1_0/LteSignalStrength;

    .line 24
    .local v0, "other":Landroid/hardware/radio/V1_0/LteSignalStrength;
    iget v1, p0, Landroid/hardware/radio/V1_0/LteSignalStrength;->signalStrength:I

    iget v2, v0, Landroid/hardware/radio/V1_0/LteSignalStrength;->signalStrength:I
    ...
    iget v2, v0, Landroid/hardware/radio/V1_0/LteSignalStrength;->rsrp:I
    ...
    iget v2, v0, Landroid/hardware/radio/V1_0/LteSignalStrength;->rsrq:I
    ...
    iget v2, v0, Landroid/hardware/radio/V1_0/LteSignalStrength;->rssnr:I
    ...
    iget v2, v0, Landroid/hardware/radio/V1_0/LteSignalStrength;->cqi:I
    ...
    iget v2, v0, Landroid/hardware/radio/V1_0/LteSignalStrength;->timingAdvance:I
...
.method public final readFromParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, p1, v0, v2, v3}, Landroid/hardware/radio/V1_0/LteSignalStrength;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public final writeToParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, v0, v2, v3}, Landroid/hardware/radio/V1_0/LteSignalStrength;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
