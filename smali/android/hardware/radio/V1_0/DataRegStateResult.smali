...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    .line 76
    .local v10, "_hidl_vec":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/hardware/radio/V1_0/DataRegStateResult;>;"
    ...
    .line 86
    new-instance v11, Landroid/hardware/radio/V1_0/DataRegStateResult;

    invoke-direct {v11}, Landroid/hardware/radio/V1_0/DataRegStateResult;-><init>()V

    .line 87
    .local v11, "_hidl_vec_element":Landroid/hardware/radio/V1_0/DataRegStateResult;
    mul-int/lit8 v1, v9, 0x68

    int-to-long v2, v1

    invoke-virtual {v11, p0, v13, v2, v3}, Landroid/hardware/radio/V1_0/DataRegStateResult;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    .line 92
    .end local v11    # "_hidl_vec_element":Landroid/hardware/radio/V1_0/DataRegStateResult;
    :cond_0
    return-object v10
.end method
...
.method public static final writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v4, v3, v6, v7}, Landroid/hardware/radio/V1_0/DataRegStateResult;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    const-class v2, Landroid/hardware/radio/V1_0/DataRegStateResult;
    ...
    .line 22
    check-cast v0, Landroid/hardware/radio/V1_0/DataRegStateResult;

    .line 23
    .local v0, "other":Landroid/hardware/radio/V1_0/DataRegStateResult;
    iget v1, p0, Landroid/hardware/radio/V1_0/DataRegStateResult;->regState:I

    iget v2, v0, Landroid/hardware/radio/V1_0/DataRegStateResult;->regState:I
    ...
    iget v2, v0, Landroid/hardware/radio/V1_0/DataRegStateResult;->rat:I
    ...
    iget v2, v0, Landroid/hardware/radio/V1_0/DataRegStateResult;->reasonDataDenied:I
    ...
    iget v2, v0, Landroid/hardware/radio/V1_0/DataRegStateResult;->maxDataCalls:I
    ...
    iget-object v2, v0, Landroid/hardware/radio/V1_0/DataRegStateResult;->cellIdentity:Landroid/hardware/radio/V1_0/CellIdentity;
...
.method public final readFromParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, p1, v0, v2, v3}, Landroid/hardware/radio/V1_0/DataRegStateResult;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public final toString()Ljava/lang/String;
    ...
    .line 59
    const-string/jumbo v1, ", .reasonDataDenied = "
    ...
    .line 61
    const-string/jumbo v1, ", .maxDataCalls = "
...
.method public final writeToParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, v0, v2, v3}, Landroid/hardware/radio/V1_0/DataRegStateResult;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
