...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    .line 90
    .local v10, "_hidl_vec":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/hardware/radio/V1_0/SimApdu;>;"
    ...
    .line 100
    new-instance v11, Landroid/hardware/radio/V1_0/SimApdu;

    invoke-direct {v11}, Landroid/hardware/radio/V1_0/SimApdu;-><init>()V

    .line 101
    .local v11, "_hidl_vec_element":Landroid/hardware/radio/V1_0/SimApdu;
    mul-int/lit8 v1, v9, 0x28

    int-to-long v2, v1

    invoke-virtual {v11, p0, v13, v2, v3}, Landroid/hardware/radio/V1_0/SimApdu;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    .line 106
    .end local v11    # "_hidl_vec_element":Landroid/hardware/radio/V1_0/SimApdu;
    :cond_0
    return-object v10
.end method
...
.method public static final writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v4, v3, v6, v7}, Landroid/hardware/radio/V1_0/SimApdu;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    const-class v2, Landroid/hardware/radio/V1_0/SimApdu;
    ...
    .line 24
    check-cast v0, Landroid/hardware/radio/V1_0/SimApdu;

    .line 25
    .local v0, "other":Landroid/hardware/radio/V1_0/SimApdu;
    iget v1, p0, Landroid/hardware/radio/V1_0/SimApdu;->sessionId:I

    iget v2, v0, Landroid/hardware/radio/V1_0/SimApdu;->sessionId:I
    ...
    iget v2, v0, Landroid/hardware/radio/V1_0/SimApdu;->cla:I
    ...
    iget v2, v0, Landroid/hardware/radio/V1_0/SimApdu;->instruction:I
    ...
    iget v2, v0, Landroid/hardware/radio/V1_0/SimApdu;->p1:I
    ...
    iget v2, v0, Landroid/hardware/radio/V1_0/SimApdu;->p2:I
    ...
    iget v2, v0, Landroid/hardware/radio/V1_0/SimApdu;->p3:I
    ...
    iget-object v2, v0, Landroid/hardware/radio/V1_0/SimApdu;->data:Ljava/lang/String;
...
.method public final readFromParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, p1, v0, v2, v3}, Landroid/hardware/radio/V1_0/SimApdu;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public final writeToParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, v0, v2, v3}, Landroid/hardware/radio/V1_0/SimApdu;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
