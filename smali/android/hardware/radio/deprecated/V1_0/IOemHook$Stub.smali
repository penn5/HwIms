...
.method public final interfaceChain()Ljava/util/ArrayList;
    ...
    .line 314
    const-string/jumbo v2, "android.hardware.radio.deprecated@1.0::IOemHook"
...
.method public onTransact(ILandroid/os/HwParcel;Landroid/os/HwParcel;I)V
    ...
    .line 390
    :sswitch_1
    const-string/jumbo v20, "android.hardware.radio.deprecated@1.0::IOemHook"
    ...
    invoke-static/range {v20 .. v20}, Landroid/hardware/radio/deprecated/V1_0/IOemHookResponse;->asInterface(Landroid/os/IHwBinder;)Landroid/hardware/radio/deprecated/V1_0/IOemHookResponse;

    move-result-object v18

    .line 393
    .local v18, "oemHookResponse":Landroid/hardware/radio/deprecated/V1_0/IOemHookResponse;
    invoke-virtual/range {p2 .. p2}, Landroid/os/HwParcel;->readStrongBinder()Landroid/os/IHwBinder;

    move-result-object v20

    invoke-static/range {v20 .. v20}, Landroid/hardware/radio/deprecated/V1_0/IOemHookIndication;->asInterface(Landroid/os/IHwBinder;)Landroid/hardware/radio/deprecated/V1_0/IOemHookIndication;

    move-result-object v17

    .line 394
    .local v17, "oemHookIndication":Landroid/hardware/radio/deprecated/V1_0/IOemHookIndication;
    ...
    invoke-virtual {v0, v1, v2}, Landroid/hardware/radio/deprecated/V1_0/IOemHook$Stub;->setResponseFunctions(Landroid/hardware/radio/deprecated/V1_0/IOemHookResponse;Landroid/hardware/radio/deprecated/V1_0/IOemHookIndication;)V
    ...
    .line 402
    .end local v17    # "oemHookIndication":Landroid/hardware/radio/deprecated/V1_0/IOemHookIndication;
    .end local v18    # "oemHookResponse":Landroid/hardware/radio/deprecated/V1_0/IOemHookResponse;
    :sswitch_2
    const-string/jumbo v20, "android.hardware.radio.deprecated@1.0::IOemHook"
    ...
    invoke-virtual {v0, v1, v15}, Landroid/hardware/radio/deprecated/V1_0/IOemHook$Stub;->sendRequestRaw(ILjava/util/ArrayList;)V

    goto :goto_0

    .line 412
    .end local v15    # "data":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/Byte;>;"
    .end local v19    # "serial":I
    :sswitch_3
    const-string/jumbo v20, "android.hardware.radio.deprecated@1.0::IOemHook"
    ...
    invoke-virtual {v0, v1, v2}, Landroid/hardware/radio/deprecated/V1_0/IOemHook$Stub;->sendRequestStrings(ILjava/util/ArrayList;)V
    ...
    .line 424
    invoke-virtual/range {p0 .. p0}, Landroid/hardware/radio/deprecated/V1_0/IOemHook$Stub;->interfaceChain()Ljava/util/ArrayList;
    ...
    .line 444
    invoke-virtual/range {p0 .. p0}, Landroid/hardware/radio/deprecated/V1_0/IOemHook$Stub;->interfaceDescriptor()Ljava/lang/String;
    ...
    .line 455
    invoke-virtual/range {p0 .. p0}, Landroid/hardware/radio/deprecated/V1_0/IOemHook$Stub;->getHashChain()Ljava/util/ArrayList;
    ...
    .line 485
    invoke-virtual/range {p0 .. p0}, Landroid/hardware/radio/deprecated/V1_0/IOemHook$Stub;->setHALInstrumentation()V
    ...
    .line 503
    invoke-virtual/range {p0 .. p0}, Landroid/hardware/radio/deprecated/V1_0/IOemHook$Stub;->getDebugInfo()Landroid/hidl/base/V1_0/DebugInfo;
    ...
    .line 514
    invoke-virtual/range {p0 .. p0}, Landroid/hardware/radio/deprecated/V1_0/IOemHook$Stub;->notifySyspropsChanged()V
...
.method public registerAsService(Ljava/lang/String;)V
    ...
    .prologue
    .line 376
    invoke-virtual {p0, p1}, Landroid/hardware/radio/deprecated/V1_0/IOemHook$Stub;->registerService(Ljava/lang/String;)V
